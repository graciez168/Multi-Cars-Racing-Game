...
public class GameMain {
   ...
   public static void main(String[] args) {
      ...
      JLabel message = new JLabel("Welcome to the Race!", JLabel.CENTER);
      ...
      while (true) {  // Repeats until a game is started or the user cancels.
         ...
         int action = JOptionPane.showConfirmDialog(null, inputPanel, "The Race", 
